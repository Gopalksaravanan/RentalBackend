...
export const errorHandler = {
  ...
  handleError: (errorToHandle: unknown): number => {
    try {
      ...
      console.error("Uncaught Error Occured: ", errorToHandle);
      const appError: AppError = covertUnknownToAppError(errorToHandle);
      // @ts-ignore
      logger.error(appError.message, appError.isCatastrophic);
      ...
      console.error("Error on Handling error", handlingError)
